  ...
  const eveonlineStrategy = new OAuth2Strategy(
    {
      ...
      scope: 'esi-markets.read_character_orders.v1 esi-wallet.read_character_wallet.v1 esi-wallet.read_corporation_wallet.v1 esi-wallet.read_corporation_wallets.v1',
    },
    async (
      accessToken: string,
      refreshToken: string,
